...
#define FIRST_FREE_TYPE		4
#define FIRST_USER_TYPE		FIRST_FREE_TYPE + COUNT_OF_TYPES

struct field_data
{
	explicit field_data () : offset (0), type (0) {};
	explicit field_data (unsigned int o, short int t) : offset (o), type (t) {};
...
struct type_data
{
	explicit type_data () : id (0), size (0) {};
	explicit type_data ( short int i, unsigned int s ) : id (i), size (s) {};
