...
// Remember where the custom steps begin, so we can delete them in the destructor
#define FIRST_CUSTOM_STEP 1
#define LAST_CUSTOM_STEP 1// !!!!!!!!!! 2

// The destructor deletes entries in the internal array corresponding to custom steps.
CDialogChooser::~CDialogChooser()
{
