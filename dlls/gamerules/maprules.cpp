...
void CGameScore::RealUse( CBaseEntity *pActivator, CBaseEntity *pCaller, USE_TYPE useType, float value )
{
...
void CGameEnd::RealUse( CBaseEntity *pActivator, CBaseEntity *pCaller, USE_TYPE useType, float value )
{
	if ( !CanFireForActivator( pActivator ) )
		return;
...
void CGameText::RealUse( CBaseEntity *pActivator, CBaseEntity *pCaller, USE_TYPE useType, float value )
{
	if ( !CanFireForActivator( pActivator ) )
		return;
...
void CGameTeamMaster::RealUse( CBaseEntity *pActivator, CBaseEntity *pCaller, USE_TYPE useType, float value )
{
	if ( !CanFireForActivator( pActivator ) )
		return;
...
void CGameTeamSet::RealUse( CBaseEntity *pActivator, CBaseEntity *pCaller, USE_TYPE useType, float value )
{
	if ( !CanFireForActivator( pActivator ) )
		return;
...
void CGamePlayerZone::RealUse( CBaseEntity *pActivator, CBaseEntity *pCaller, USE_TYPE useType, float value )
{
...
void CGamePlayerHurt::RealUse( CBaseEntity *pActivator, CBaseEntity *pCaller, USE_TYPE useType, float value )
{
	if ( !CanFireForActivator( pActivator ) )
		return;
...
void CGameCounter::RealUse( CBaseEntity *pActivator, CBaseEntity *pCaller, USE_TYPE useType, float value )
{
	if ( !CanFireForActivator( pActivator ) )
		return;
...
void CGameCounterSet::RealUse( CBaseEntity *pActivator, CBaseEntity *pCaller, USE_TYPE useType, float value )
{
	if ( !CanFireForActivator( pActivator ) )
		return;
...
void CGamePlayerEquip::RealUse( CBaseEntity *pActivator, CBaseEntity *pCaller, USE_TYPE useType, float value )
{
...
void CGamePlayerTeam::RealUse( CBaseEntity *pActivator, CBaseEntity *pCaller, USE_TYPE useType, float value )
{
	if ( !CanFireForActivator( pActivator ) )
		return;
...
//============ CAPTURE ZONE - SPECIFIC TRIGGER FOR CTF GAME MODE ===============
...
LINK_ENTITY_TO_CLASS(trigger_capture_zone, CCaptureZone);
...
void CCaptureZone::Touch(CBaseEntity *pOther)
{
	...
	{
		if (pPlayer->m_pCarryingObject->pev->team == pev->team)
		{
			pPlayer->m_pCarryingObject->Use(pOther, this, USE_TOGGLE, 0);
		}
	}
}
...
class CCapturePoint : public CCaptureZone
{
public:
	void Spawn(void);
};

LINK_ENTITY_TO_CLASS(info_capture_zone, CCapturePoint);

void CCapturePoint::Spawn(void)
{
	if (!g_pGameRules->IsCTF())
	{
		UTIL_Remove(this);
